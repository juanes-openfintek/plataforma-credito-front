...
const Analyst3Dashboard = () => {
  ...
  return (
    <div className='space-y-8'>
      {/* Header */}
      <div>
        <h1 className='text-3xl font-bold text-gray-900'>Panel de Analista 3</h1>
        <p className='text-gray-600 mt-1'>Preaprobación, documentos y desembolso</p>
      </div>
      ...
      <div className='bg-white rounded-2xl shadow-md p-6 border border-gray-100'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <a
            href='/analista3/creditos'
            className='flex items-center gap-4 p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition-colors border border-purple-200'
          >
          ...
          <div className='flex items-center gap-4 p-4 bg-indigo-50 rounded-xl border border-indigo-200'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-600'>Documentos y desembolso</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {recentCredits.length > 0 && (
        <div className='bg-white rounded-2xl shadow-md p-6 border border-gray-100'>
          <div className='flex justify-between items-center mb-4'>
            ...
            <a href='/analista3/creditos' className='text-purple-600 hover:text-purple-800 font-semibold text-sm'>
              Ver todos →
            </a>
          </div>
...
export default Analyst3Dashboard
