    ...
    .then(async (res: any) => {
      ...
      <div>
        ...
        <h1 style="color: #01b8e5;">¡Hola ${decryptedData.name}!</h1>
            <p>
            Tu credito fue <span style="color: red;">RECHAZADO</span>. Dirigete a Feelpay dando clic
            <a style="color: #01b8e5;" href="https://feelpay-front.vercel.app/">AQUÍ</a> para que puedas
            tener mas información al respecto.
            </p>
      </div>`
      return await axios
        .post(
