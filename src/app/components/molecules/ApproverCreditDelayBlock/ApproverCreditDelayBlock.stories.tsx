...
import ApproverCreditDelayBlock from './ApproverCreditDelayBlock'

const meta = {
  title: 'Components/Molecules/ApproverCreditDelayBlock',
  component: ApproverCreditDelayBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof ApproverCreditDelayBlock>
