...
import AdminBankUserBlock from './AdminBankUserBlock'

const meta = {
  title: 'Components/Molecules/AdminBankUserBlock',
  component: AdminBankUserBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminBankUserBlock>
