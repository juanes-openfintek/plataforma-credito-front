...
import AdminStatisticsBlock from './AdminStatisticsBlock'

const meta = {
  title: 'Components/Molecules/AdminStatisticsBlock',
  component: AdminStatisticsBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminStatisticsBlock>
