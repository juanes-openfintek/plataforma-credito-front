...
import ApproverCreditDisburseBlock from './ApproverCreditDisburseBlock'

const meta = {
  title: 'Components/Molecules/ApproverCreditDisburseBlock',
  component: ApproverCreditDisburseBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof ApproverCreditDisburseBlock>
