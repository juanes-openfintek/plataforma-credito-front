...
import AdminCreditBlock from './AdminCreditBlock'

const meta = {
  title: 'Components/Molecules/AdminCreditBlock',
  component: AdminCreditBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminCreditBlock>
