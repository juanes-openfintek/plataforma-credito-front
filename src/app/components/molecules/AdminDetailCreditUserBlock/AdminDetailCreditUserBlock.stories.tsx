...
import AdminDetailCreditUserBlock from './AdminDetailCreditUserBlock'

const meta = {
  title: 'Components/Molecules/AdminDetailCreditUserBlock',
  component: AdminDetailCreditUserBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminDetailCreditUserBlock>
