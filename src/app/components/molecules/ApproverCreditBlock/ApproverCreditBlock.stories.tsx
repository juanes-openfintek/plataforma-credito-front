...
import ApproverCreditBlock from './ApproverCreditBlock'

const meta = {
  title: 'Components/Molecules/ApproverCreditBlock',
  component: ApproverCreditBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof ApproverCreditBlock>
