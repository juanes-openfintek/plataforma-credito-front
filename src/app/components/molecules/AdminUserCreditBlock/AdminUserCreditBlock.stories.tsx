...
import AdminUserCreditBlock from './AdminUserCreditBlock'

const meta = {
  title: 'Components/Molecules/AdminUserCreditBlock',
  component: AdminUserCreditBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminUserCreditBlock>
