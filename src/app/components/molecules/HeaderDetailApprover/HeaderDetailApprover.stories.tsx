...
import HeaderDetailApprover from './HeaderDetailApprover'

const meta = {
  title: 'Components/Molecules/HeaderDetailApprover',
  component: HeaderDetailApprover,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof HeaderDetailApprover>
