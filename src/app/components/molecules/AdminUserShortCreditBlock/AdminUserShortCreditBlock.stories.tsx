...
import AdminUserShortCreditBlock from './AdminUserShortCreditBlock'

const meta = {
  title: 'Components/Molecules/AdminUserShortCreditBlock',
  component: AdminUserShortCreditBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminUserShortCreditBlock>
