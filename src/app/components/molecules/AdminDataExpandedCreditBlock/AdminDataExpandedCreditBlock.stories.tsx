...
import AdminDataExpandedCreditBlock from './AdminDataExpandedCreditBlock'

const meta = {
  title: 'Components/Molecules/AdminDataExpandedCreditBlock',
  component: AdminDataExpandedCreditBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminDataExpandedCreditBlock>
