...
import ApproverCreditWaitBlock from './ApproverCreditWaitBlock'

const meta = {
  title: 'Components/Molecules/ApproverCreditWaitBlock',
  component: ApproverCreditWaitBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof ApproverCreditWaitBlock>
