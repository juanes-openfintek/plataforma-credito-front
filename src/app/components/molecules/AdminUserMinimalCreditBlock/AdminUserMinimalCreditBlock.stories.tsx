...
import AdminUserMinimalCreditBlock from './AdminUserMinimalCreditBlock'

const meta = {
  title: 'Components/Molecules/AdminUserMinimalCreditBlock',
  component: AdminUserMinimalCreditBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof AdminUserMinimalCreditBlock>
