...
const Analyst2CreditList = ({ creditsList, page, perPage, onSelectCredit }: Props) => {
            ...
            {paginatedCredits.map((credit, index) => {
              ...
              return (
                <tr key={credit._id || index} className='border-b hover:bg-gray-50'>
                  ...
                  <td className='p-3'>${Number(credit.amount || 0).toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</td>
                  <td className='p-3'>
...
export default Analyst2CreditList
