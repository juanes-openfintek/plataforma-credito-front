...
import DisburseCreditSevenColBlock from '../../molecules/DisburseCreditSevenColBlock/DisburseCreditSevenColBlock'

interface DisburseCreditListSevenColProps {
...
const DisburseCreditListSevenCol = ({
  creditsList,
  formik,
  page,
  perPage,
  actionLabel,
  handleShowForm,
}: DisburseCreditListSevenColProps) => {
  return (
    <div className='bg-light-color-one rounded-2xl px-6 py-6 mt-8'>
      <div className='grid grid-cols-7 max-lg:grid-cols-3 text-center font-bold text-[1.125rem]'>
        ...
        <h3 className='max-lg:hidden'>#cuenta</h3>
        <h3>Acción</h3>
      </div>
      {creditsList
...
export default DisburseCreditListSevenCol
