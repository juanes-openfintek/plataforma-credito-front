...
/**
 * CheckStateLibranza is a component that renders the check state for Libranza credit
 * @example <CheckStateLibranza />
 * @returns The CheckStateLibranza component
 */
const CheckStateLibranza = () => {
  /**
      ...
      >
        <div className='w-1/2 flex max-lg:w-full'>
          <NextImage
            ...
            alt='Consulta tu crédito libranza'
            width={450}
            height={450}
          />
          <h2 className='font-sans text-4xl 2xl:text-[3.125rem] leading-[3rem] text-white z-10 2xl:px-10 2xl:mr-10 max-lg:text-center self-center max-lg:mt-16'>
            <span className='font-bold'>Consulta el estado</span> de tu crédito libranza aqui
          </h2>
        </div>
      ...
      {state && (
        <>
          {state.status && (
            <div className='z-10 mx-10'>
              <p className='text-white text-2xl mb-4 text-center'>
                El estado de tu crédito libranza es{' '}
                ...
                . Para más información ingresa a tu portal digital en
              </p>
              <a href='/login'>
          ...
          {!state.status && (
            <div className='z-10 mx-10'>
              <p className='text-white text-2xl mb-4 text-center'>
                No encontramos créditos libranza asociados a este documento. Inicia una solicitud en nuestra landing para obtener tu cupo digital.
              </p>
              <a href='/login'>
                <RoundButton text='Iniciar sesión' />
              </a>
...
export default CheckStateLibranza
