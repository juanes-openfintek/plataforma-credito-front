...
const Analyst1Dashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      // Contar por estados simplificados
  ...
  return (
    <div className='space-y-8'>
      ...
      <div>
        ...
        <p className='text-gray-600 mt-1'>Validación inicial de créditos</p>
      </div>
      ...
      <div className='bg-white rounded-2xl shadow-md p-6 border border-gray-100'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <a
            href='/analista1/creditos'
            className='flex items-center gap-4 p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors border border-blue-200'
          >
          ...
          <div className='flex items-center gap-4 p-4 bg-purple-50 rounded-xl border border-purple-200'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-600'>Validación inicial y KYC</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {recentCredits.length > 0 && (
        <div className='bg-white rounded-2xl shadow-md p-6 border border-gray-100'>
          <div className='flex justify-between items-center mb-4'>
            ...
            <a href='/analista1/creditos' className='text-blue-600 hover:text-blue-800 font-semibold text-sm'>
              Ver todos →
            </a>
          </div>
...
export default Analyst1Dashboard
